...
func TestLoadTemplatesNested(t *testing.T) {
	...
	test.AssertStringEquals(t, "Template result data1", "Imp 1.0 - Count is 4 Material is More Silk --PART 1 Silk-- --PART 2 is 4 of Silk -- --PART 3 wants More--", txt1)
...
func TestFileGroupTemplates(t *testing.T) {
	...
	test.AssertErrorIsNil(t, "", err1)
	test.AssertStringEquals(t, "Template result data1", "Imp 1.0 - Count is 4 Material is More Silk --PART 1 Silk-- --PART 2 is 4 of Silk -- --PART 3 wants More--", buf.String())
...
func TestLoadTemplatesFromPath(t *testing.T) {
	...
	test.AssertStringEquals(t, "Template result data1", "S1 - Count is 2 Material is Metal", txt1)

	test.AssertBoolTrue(t, "", templ.HasTemplate("simple2.html"))
	txt2 := templ.ExecuteString("simple2.html", data2)
	test.AssertStringEquals(t, "Template result data2", "S2 - Material is Zinc Count is 4", txt2)
	...
	test.AssertStringEquals(t, "S3 - Template result mapped", "S3 - Material is Fire Count is SIX", txt4)
	...
	test.AssertStringEquals(t, "S3 - Template result mapped", "S3 - Material is Water Count is 4", txt5)
}
...
func TestStaticTemplates(t *testing.T) {
	...
	test.AssertErrorIsNil(t, "", err1)
	test.AssertStringEquals(t, "Template result data1", "Count is 7 Material is Silk", buf.String())

	buf.Reset()
	err2 := tmpl.Execute(buf, data2)
	test.AssertErrorIsNil(t, "", err2)
	test.AssertStringEquals(t, "Template result data2", "Count is 9 Material is Wool", buf.String())
}
...
func TestFileTemplates(t *testing.T) {
	...
	err1 := tmpl.Execute(buf, data1)
	test.AssertErrorIsNil(t, "", err1)
	test.AssertStringEquals(t, "Template result data1", "S1 - Count is 7 Material is Silk", buf.String())

	buf.Reset()
	err2 := tmpl.Execute(buf, data2)
	test.AssertErrorIsNil(t, "", err2)
	test.AssertStringEquals(t, "Template result data2", "S1 - Count is 9 Material is Wool", buf.String())
}
